...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        {
            await _context.Database.EnsureCreatedAsync();  //garantiza que en este punto la DB este creada; await espera la creación de la DB
            await CheckRoles();
            ...
            await CheckPropertyTypesAsync(); // Crea los tipos de propirdades
